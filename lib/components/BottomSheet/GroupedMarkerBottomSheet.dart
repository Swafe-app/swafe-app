...
class GroupedMarkerBottomSheet extends StatelessWidget {
  ...
  const GroupedMarkerBottomSheet({super.key, required this.reports});
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Column(children:[ ListTile(
                      leading: Container(
                        ...
                        decoration: ShapeDecoration(
                            image: DecorationImage(
                              image: AssetImage(convertStringToReportingType(reports[index].selectedDangerItems.first).pin),
                              fit: BoxFit.fill,
                            ),
                      ...
                      title: Text(convertStringToReportingType(reports[index].selectedDangerItems.first).title),
                    ),
                      const SizedBox(
                        height: Spacing.standard,
                      )]);
